...
public abstract class AbstractOlympiadGame
{
	...
	public static void rewardQuests(Player player)
	{
		...
		{
			Quest.giveItems(player, Config.EXALTED_FOR_VICTORY_ITEM_MAX.getId(), 1);
			Quest.playSound(player, QuestSound.ITEMSOUND_QUEST_ITEMGET);
			if (Quest.getQuestItemsCount(player, Config.EXALTED_FOR_VICTORY_ITEM_MAX.getId()) >= Config.EXALTED_FOR_VICTORY_ITEM_MAX.getCount())
			{
				qs2.setCond(4, true);
			}
		}
